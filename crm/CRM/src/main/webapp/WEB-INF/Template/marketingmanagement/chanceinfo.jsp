    ...
    <table class="table table-striped table-bordered table-condensed list">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="500">
                    <input name="sal_chance_t.chc_id" value="${sal_chance_t.chc_id }" type="text" />                </td>
                <td width="500">机会来源<font color="FF0000">*</font></td>
                <td width="500">
                    <input name="sal_chance_t.chc_source" value="${sal_chance_t.chc_source }" type="text" /></td>
            </tr>
            <tr>
                <td>客户名称<font color="FF0000">*</font></td>
                <td>
                    <input name="sal_chance_t.chc_cust_name" value="${sal_chance_t.chc_cust_name }" type="text" /></td>
                <td>成功几率<font color="FF0000">*</font></td>
                <td>
                    <input name="sal_chance_t.chc_rate" value="${sal_chance_t.chc_rate }" type="text" /></td>
            </tr>
			<tr>
                <td>概要</td>
                <td colspan="3"><input type="text" style="width:500px;" name="sal_chance_t.chc_title" value="${sal_chance_t.chc_title }"/></td>
            </tr>
			
            <tr>
                <td><span class="STYLE1">联系人</span><font color="FF0000">*</font></td>
                <td>
                    <input name="sal_chance_t.chc_linkman" value="${sal_chance_t.chc_linkman }" type="text" />                </td>
                <td>联系人电话<font color="FF0000">*</font></td>
                <td>
                    <input name="sal_chance_t.chc_tel" value="${sal_chance_t.chc_tel }" type="text" /></td>
            </tr>
           
            <tr>
                <td width="15%">机会描述</td>
                <td width="500" colspan="3" height="">
                    <textarea name="sal_chance_t.chc_desc" style="width: 95%" rows="4" cols="5">${sal_chance_t.chc_desc }</textarea>                </td>
            </tr>
			<tr>
                <td width="15%">创建人<font color="FF0000">*</font></td>
                <td>
                    <input name="sal_chance_t.chc_create_by" value="${sal_chance_t.chc_create_by }" readonly="readonly" type="text" />                </td>
                <td width="500">创建时间</td>
                <td width="500">
                    <input name="sal_chance_t.chc_create_date" value="${sal_chance_t.chc_create_date }" type="text" id="today"/>                </td>
            </tr>
			<tr>
                ...
                <td width="500">
                    <input name="sal_chance_t.chc_due_date" value="${sal_chance_t.chc_due_date}" type="text"  />                </td>
            </tr>
