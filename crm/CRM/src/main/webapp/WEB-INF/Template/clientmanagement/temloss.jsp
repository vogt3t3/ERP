...
<body>
    <div class="alert alert-info">当前位置<b class="tip"></b>客户流失管理<b class="tip"></b>暂时流失</div>
    <form id="lstInfo" action="client/mod_Lst" method="post">
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
             ...
             <tr>
                <td colspan="4">
                 <input class="btn btn-inverse"  type="button" value="确认流失" onclick="window.location.href='client/open_sureLst?lstId=${lst.lst_id }'"/>
