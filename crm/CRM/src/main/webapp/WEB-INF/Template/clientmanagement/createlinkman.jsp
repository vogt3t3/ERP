        ...
        <tbody>
             ...
             <tr>
                <td colspan="4">
                    ...
                    <input class="btn btn-inverse" type="button" value="返回" onclick="window.location.href='javascript:history.back()'"/>
            ...
            <td width="40">性别</td>
            <td width="40">女：<input type="radio"name="cst_linkman_t.link_sex" value="女" />男：<input type="radio" name="cst_linkman_t.link_sex" value="男" /></td>
            </tr>
            <tr>
           	<td width="40">职位*</td>
