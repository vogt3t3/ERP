    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#find').click(function () {
        		...
        		$("#chart").attr("src","stat/service_Analysis?year="+value);	 //将返回的结果显示到ajaxDiv中
            })
        })
...
<body>
    <div class="alert alert-info">当前位置<b class="tip"></b>统计报表<b class="tip"></b>客户服务分析</div>
    ...
    <table class="table table-striped table-bordered table-condensed" id="list">
        <thead>
            <tr class="tr_detail">
                ...
                <td width="28%"><div align="center">条目</div></td>
                <td width="44%"><div align="center">服务数量</div></td>
            </tr>
        </thead>
        <tbody>
            <tr>
