...
<body>
    ...
    <table class="table table-striped table-bordered table-condensed" id="list">
        ...
        <c:forEach items="${proList }" var="pro">
            ...
            <tr>
                <td><div align="center">${pro.pro_id }</td>
                <td><div align="center">${pro.pro_name}</td>
                <td><div align="center">${pro.pro_type}</td>
                <td><div align="center">${pro.pro_rank}</td>
                <td><div align="center">${pro.pro_unit }</td>
                 <td><div align="center">${pro.pro_price }</td>
                  <td><div align="center">${pro.pro_remark }</td>
                <td><div align="center"><input type="button" class="btn btn-inverse" id="edit" value="编辑" onclick="window.location.href='dict/pro_Alter?id=${pro.pro_id}' "/></td>
